...
def number(x):
  ...
  if x == random_number :
    ...
    print(f"Fail! Your number: {x} , Random number: {random_number} ")
...
make_shirt()
make_shirt("medium")
make_shirt("small","I love Data")
make_shirt(size="medium",text="I love Code")
...
def get_random_temp(month):
  if month in winter :
    ...
    print(f"is winter saison so the temperature is colder : {temp}")
  elif month in spring :
    temp = random.randint(19,27)
    print(f"is spring saison so the temperature is average : {temp}")
  elif month in summer :
    temp = random.randint(28,35)
    print(f"is summer saison so the temperature is warming : {temp}")
  elif month in autumn :
    temp = random.randint(12,20)
    print(f"is autumn saison so the temperature is cooling : {temp}")
